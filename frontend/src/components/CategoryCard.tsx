...
const CategoryCard = ({
  ...
  return (
    <div className="group relative w-80 rounded-2xl overflow-hidden bg-gradient-to-br from-white to-gray-50 shadow-lg hover:shadow-2xl transition-all duration-500">
      {/* Discount Badge */}
      {discount && (
        <div className="absolute top-4 right-4 z-20 bg-red-500 text-white px-3 py-1 rounded-full text-sm font-bold">
          {discount}
        </div>
      )}
      ...
      {/* Featured Badge */}
      {featured && (
        <div className="absolute top-4 left-4 z-20 flex items-center gap-1 bg-yellow-400 text-gray-900 px-3 py-1 rounded-full text-sm font-bold">
